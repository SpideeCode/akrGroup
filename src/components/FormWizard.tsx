      ...
      >
        ...
        <div className="p-6 md:p-10 bg-brand-dark/5 flex justify-between gap-4 flex-shrink-0 mt-auto border-t border-brand-dark/5 safe-area-padding-bottom">
          <button
            ...
            className="flex-1 md:flex-none flex items-center justification-center gap-3 px-6 md:px-8 py-4 font-montserrat font-bold uppercase text-xs tracking-widest text-brand-dark border-2 border-brand-dark transition-all hover:bg-brand-dark hover:text-white disabled:opacity-20 disabled:pointer-events-none disabled:border-brand-dark/20 min-h-[56px] md:min-h-[auto]"
          >
